...
def test_render_dockerfile_uses_configured_base_image_ref():
    ...
    assert dockerfile.startswith("FROM ghcr.io/harshitkmr10/boxkite-sandbox:latest\n")
...
def test_render_dockerfile_for_minimal_base_uses_its_own_image_ref():
    ...
    assert dockerfile.startswith("FROM ghcr.io/harshitkmr10/boxkite-sandbox-minimal:latest\n")
...
def test_render_dockerfile_for_node_base_uses_its_own_image_ref():
    ...
    assert dockerfile.startswith("FROM ghcr.io/harshitkmr10/boxkite-sandbox-node:latest\n")
...
def test_render_dockerfile_for_go_base_uses_its_own_image_ref():
    ...
    assert dockerfile.startswith("FROM ghcr.io/harshitkmr10/boxkite-sandbox-go:latest\n")
...
def test_render_dockerfile_for_nextjs_base_uses_its_own_image_ref():
    ...
    assert dockerfile.startswith("FROM ghcr.io/harshitkmr10/boxkite-sandbox-nextjs:latest\n")
    assert "npm install -g typescript==5.6.0" in dockerfile
...
def test_render_dockerfile_for_rust_base_uses_its_own_image_ref():
    ...
    assert dockerfile.startswith("FROM ghcr.io/harshitkmr10/boxkite-sandbox-rust:latest\n")
