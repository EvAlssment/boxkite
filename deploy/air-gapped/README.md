...
pull the already-published `ghcr.io/harshitkmr10/boxkite-sandbox` /
...
```
$ docker pull ghcr.io/harshitkmr10/boxkite-sidecar:0.1.0
Error response from daemon: error from registry: unauthorized

$ curl -sI https://ghcr.io/v2/harshitkmr10/boxkite-sidecar/manifests/0.1.0
HTTP/2 401
